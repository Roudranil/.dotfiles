...
return {
    ...
    DiffAdded = { fg = colors.custom_brght_green },
    DiffChange = { fg = colors.light_grey },
    DiffChangeDelete = { fg = colors.custom_brght_red },
    DiffModified = { fg = colors.custom_brght_orange },
    DiffDelete = { fg = colors.custom_brght_red },
    DiffRemoved = { fg = colors.custom_brght_red },
