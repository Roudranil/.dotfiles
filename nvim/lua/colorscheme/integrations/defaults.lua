...
local defaults = {
    ...
    EndOfBuffer = { fg = mocha.surface1 },
    -- floating windows
    FloatBorder = {fg = colors.blue},
    NormalFloat = {bg = colors.darker_black},
    NvimInternalError = {fg = colors.red},
    VertSplit = {fg = mocha.surface1, bg = mocha.base},
    WinSeparator = {link = "VertSplit"},
    Normal = {fg = theme.base05, bg = theme.base00},
    Bold = {bold = true},
    Debug = {fg = theme.base08},
    Directory = {fg = theme.base0D},
    Error = {underline = true, sp = colors.red, fg = colors.red},
